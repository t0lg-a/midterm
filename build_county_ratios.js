...
async function main() {
  ...
  // 2024 national popular vote result (two-party irrelevant — use raw percentages)
  // Harris: 48.43%, Trump: 49.87% (of total vote)
  const natDemPct = 48.43;
  const natGopPct = 49.87;
  console.log(`  National baseline: D ${natDemPct}% R ${natGopPct}%`);
